...
export default class PartnerAside extends Component {
  ...
  render() {
    const { handleChangeInput, handleClickGender, handleClickPosition, handleClickReset, resetFilter } = this.props;
      ...
      <aside className="partner-filter-aside">
        <article className="partner-filter-box">
          <div className="partner-filter-search">
            ...
            <input type="search" placeholder="상담사 이름 검색" className="input-partner-filter-search" onChange={handleChangeInput} />
          </div>
        </article>
        <article className="partner-filter-box">
          <div className="MyCounselingType">
            ...
            <div className="partner-filter-keyword-wrap">
              <ul className="partner-filter-keyword-ul">
                ...
                <li className="partner-filter-keyword-li">#강박</li>
                <li className="partner-filter-keyword-li">#스트레스</li>
                <li className="partner-filter-keyword-li">#분노</li>
                <li className="partner-filter-keyword-li">#불안</li>
              </ul>
            </div>
            <div className="partner-filter-box-type">
              <h3>상담 유형</h3>
              <div className="partner-filter-box-type-row">
                <input type="checkbox" name="check-counseling-type" value="textTherapy" id="checkbox-text" defaultChecked={true} />
                <label className="type-checkbox-1" htmlFor="checkbox-text">
                  텍스트테라피
                </label>
              </div>
              <div className="partner-filter-box-type-row">
                <input type="checkbox" name="check-counseling-type" value="phoneCounsel" id="checkbox-call" defaultChecked={true} />
                <label className="type-checkbox-1" htmlFor="checkbox-call">
                  전화상담
                </label>
              </div>
              <div className="partner-filter-box-type-row">
                <input type="checkbox" name="check-counseling-type" value="meetCounsel" id="checkbox-meet" defaultChecked={true} />
        ...
        <article className="partner-filter-box">
          <div className="MyCounselingCondition">
            ...
            <button className="btn-partner-filter-keyword" type="button" onClick={handleClickReset}>
              선택 초기화
            </button>
            <div className="partner-filter-box-type level">
              ...
              <div className="partner-filter-box-type-row check-level">
                <input type="checkbox" name="subPt" value="전문 상담사" id="checkbox-sub" defaultChecked={true} onClick={handleClickPosition} />
                <label className="type-checkbox-2" htmlFor="checkbox-sub">
                  전문 상담사
                </label>
              </div>
              <div className="partner-filter-box-type-row check-level">
                <input type="checkbox" name="nomalPt" value="일반 상담사" id="checkbox-nomal" defaultChecked={true} onClick={handleClickPosition} />
            ...
            <div className="partner-filter-checkbox">
              ...
              <div className="filter-radio-wrap">
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-day-type" value="dayAll" id="radio-day-all" defaultChecked={true} />
                  <label className="type-checkbox-3" htmlFor="radio-day-all">
                    무관
                  </label>
                </div>
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-day-type" value="dayWeekdays" id="radio-weekdays" defaultChecked={false} />
                  <label className="type-checkbox-3" htmlFor="radio-weekdays">
                    평일
                  </label>
                </div>
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-day-type" value="dayWeekends" id="radio-weekends" defaultChecked={false} />
            ...
            <div className="partner-filter-checkbox">
              ...
              <div className="filter-radio-wrap">
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-certi-type" value="certiAll" id="radio-certi-all" defaultChecked={true} />
                  <label className="type-checkbox-3" htmlFor="radio-certi-all">
                    무관
                  </label>
                </div>
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-certi-type" value="certiTwo" id="radio-certi-two" defaultChecked={false} />
                  <label className="type-checkbox-3" htmlFor="radio-certi-two">
                    2급
                  </label>
                </div>
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-certi-type" value="certiOne" id="radio-certi-one" defaultChecked={false} />
            ...
            <div className="partner-filter-checkbox">
              ...
              <div className="filter-radio-wrap">
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-review-type" value="reviewAll" id="radio-review-all" defaultChecked={true} />
                  <label className="type-checkbox-3 review" htmlFor="radio-review-all">
                    무관
                  </label>
                </div>
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-review-type" value="reviewMid" id="radio-review-mid" defaultChecked={false} />
                  <label className="type-checkbox-3 review" htmlFor="radio-review-mid">
                    1회 이상
                  </label>
                </div>
                <div className="partner-filter-radio">
                  <input type="radio" name="check-counseling-review-type" value="reviewTop" id="radio-review-top" defaultChecked={false} />
            ...
            <div className="partner-filter-checkbox">
              ...
              <div className="filter-radio-wrap">
                <div className="partner-filter-radio final">
                  <input type="radio" name="check-counseling-specific-type" value="specificAll" id="radio-specific-all" defaultChecked={true} />
                  <label className="type-checkbox-3 specific-first" htmlFor="radio-specific-all">
                    무관
                  </label>
                </div>
                <div className="partner-filter-radio final">
                  <input type="radio" name="check-counseling-specific-type" value="specificQueer" id="radio-specific-queer" defaultChecked={false} />
                ...
                <div className="partner-filter-radio final">
                  <input type="radio" name="check-counseling-specific-type" value="specificEng" id="radio-specific-eng" defaultChecked={false} />
