    ...
    return (
      <section className='profile-content-reservation'>
        <article className='reservation-text-phone'>
          ...
          <div className='text-phone-sub-title'>트로스트 앱을 통해 진행하는 비대면 심리상담입니다.</div>
          <div className='text-phone-flow'>
            ...
            <div className='flow-content-wrap'>
              <div className='flow-one'>
                <img className='img-num' alt='1' src='https://d2qrvi4l1nprmf.cloudfront.net/images/service/partner/ic_one.png' />
                <img
              ...
              <div className='flow-two'>
                <img className='img-num' alt='2' src='https://d2qrvi4l1nprmf.cloudfront.net/images/service/partner/ic_two.png' />
                <img
                  className='img-process'
              ...
              <div className='flow-three'>
                <img className='img-num' alt='3' src='https://d2qrvi4l1nprmf.cloudfront.net/images/service/partner/ic_three.png' />
                <img
                  className='img-process'
        ...
        <article className='reservation-meet'>
          ...
          <div className='meet-sub-title'>상담센터에 방문하여 진행하는 대면 심리상담입니다.</div>
          ...
          <div className='meet-flow'>
            ...
            <div className='flow-content-wrap'>
              ...
              <div className='flow-four'>
                <img className='img-num' alt='4' src='https://d2qrvi4l1nprmf.cloudfront.net/images/service/partner/ic_four.png' />
                <img
                  className='img-process'
                  alt='텍스트테라피, 전화상담 예약 이미지'
        ...
        <article className='reservation-notice'>
          ...
          <div className='reservation-notice-list'>
            <ul className='reservation-list'>
              <li className='list-el'>상담 예약은 상담권 구매 후 상담방이 연결되면 상담사와 일정을 협의하여 확정합니다.</li>
              <li className='list-el'>다른 상담 진행 중인 경우 첫응대까지 시간이 소요될 수 있습니다.</li>
              <li className='list-el'>
                원하는 일정이 맞지 않는 경우, 일대일 문의에 예약 희망 시간을 남겨주세요. 원하는 시간에 최대한 상담받으실 수 있도록 도움드립니다.
              </li>
              <li className='list-el'>지금 빠르게 상담이 필요할 땐 바로상담을 이용해주세요.</li>
              <li className='list-el'>상담사찾기 메뉴에서 바로상담 배너를 선택하면 지금 상담 가능한 상담사님을 확인하실 수 있습니다.</li>
            </ul>
          </div>
        </article>
      </section>
