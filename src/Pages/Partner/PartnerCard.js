...
export default class PartnerCard extends Component {
  ...
  ptWishClassName = () => { this.setState({btnWishChange: !this.state.btnWishChange}) }
  ...
  render() {
    ...
    return (
      <article className={this.ptRecomendAdd()}>
        <button 
          className={this.state.btnWishChange ? "btn-partner-wish add-wish" : "btn-partner-wish"}
          onClick={this.ptWishClassName}>상담사 찜하기</button>
      ...
      //div partner-list-content-wrap 는 계속 주석처리
