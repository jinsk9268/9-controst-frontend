...
export default class PartnerCard extends Component {
  ...
  ptRecomendAdd = () => {
    return this.props.level === "마스터 상담사"
      ? "partner-list-box marter-recommend "
      : "partner-list-box";
  };
  ...
  render() {
    ...
    return (
      <article className={this.ptRecomendAdd()}>
        <button
          className={
            this.state.btnWishChange
              ? "btn-partner-wish add-wish"
              : "btn-partner-wish"
          }
          onClick={this.ptWishClassName}
        >
          상담사 찜하기
        </button>
        <div className="partner-info">
          ...
          <div className="partner-info-wrap-text">
            <div className="partner-info-text">
              ...
              <span className={this.ptPositionClassName()}>
                {this.props.level}
              </span>
