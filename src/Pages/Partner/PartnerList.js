...
class PartnerResult extends Component {
  ...
  ptConditionClassName = () => {this.setState({ptConditionShow: !this.state.ptConditionShow})}

  ptBtnClick = (name) => {this.setState({ptBtnOptionListShow:  name})}
      ...
      <header className="partner-list-header">
        ...
        <div className="partner-list-search-condition">
          ...
          <ul className={this.state.ptConditionShow ? "partner-list-option-list" : "partner-list-option-list not-show"}>
            <li className="partner-list-option-list-element" onClick={event => {this.ptConditionClassName(); this.ptBtnClick("고민 연관순");}}>고민 연관순</li>
            <li className="partner-list-option-list-element" onClick={event => {this.ptConditionClassName(); this.ptBtnClick("상담 만족도순");}}>상담 만족도순</li>
            <li className="partner-list-option-list-element" onClick={event => {this.ptConditionClassName(); this.ptBtnClick("낮은 상담 가격순");}}>
              낮은 상담 가격순
            </li>
            <li className="partner-list-option-list-element" onClick={event => {this.ptConditionClassName(); this.ptBtnClick("높은 상담 가격순");}}>
              높은 상담 가격순
            </li>
          </ul>
        </div>
