            ...
            if(prevProps !== this.props){
                ...
                script.onload = () => {
                    ...
                    for(let i = 0; i < positions.length; i++){
                        ...
                        marker[this.state.clickIndex] = new kakao.maps.Marker({
                            map: map, // 마커를 표시할 지도
                            position: positions[this.state.clickIndex].latlng, // 마커를 표시할 위치    
                            title : positions[this.state.clickIndex].title, // 마커의 타이틀, 마커에 마우스를 올리면 타이틀이 표시됩니다
                            image : new kakao.maps.MarkerImage(positions[this.state.clickIndex]["SelectedImg"], new kakao.maps.Size(40, 60))
                        })
