...
render() {
        ...
        <nav className="navbar">
            ...
            <ul className="navbar-login">
               <li className="navbar-login-page"><Link to="login" className="navbar-login-a" >로그인</Link></li>
               <li className="navbar-signup"><Link to="signup"className="navbar-signup-a">회원가입</Link></li>
            </ul>
        </nav>
        )
    }
